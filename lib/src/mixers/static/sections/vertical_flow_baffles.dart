...
class _VerticalFlowBafflesState extends State<VerticalFlowBaffles> {
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              ...
              AppTextFormField(
                labelText: 'W',
                helperText: "W: Width of the basin (m)",
                  ...
                  if (_formKey.currentState.validate()) {
                    double result = sqrt((1020 *
                        ...
                        (_selectedValue *
                            ...
                            pow(double.parse(_wController.text), 2));
